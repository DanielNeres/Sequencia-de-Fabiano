...
int main(){
	...
	// importante imprimir o numero antes que o valor seja modificado	
		printf("\n%d", numeroimprecao); 
	// soma o numero de impressão a outra variavel, que no incio serve para inciar a sequencia, mas após o primeiro laço ele reistra o ultimo valor usado na impreção	
